...
public class Works
{
    ...
    public void changePoss(int i, int j)
    {
        if (PossArr.isEmpty()) {
            ...
            deletePoss(i*8+j,j);
            if ((i>0)&&(j>0)) if ((!findPoss(i*8+j-9))&&(mass[i-1][j-1]=='0')) PossArr.add(new PossibleSt(i*8+j-9));
            if (i>0) if ((!findPoss(i*8+j-8))&&(mass[i-1][j]=='0'))PossArr.add(new PossibleSt(i*8+j-8));
            if ((i>0)&&(j<7)) if ((!findPoss(i*8+j-8+1))&&(mass[i-1][j+1]=='0'))PossArr.add(new PossibleSt(i*8+j-8+1));
            if (j>0) if ((!findPoss(i*8+j-1))&&(mass[i][j-1]=='0'))PossArr.add(new PossibleSt(i*8+j-1));
            if (j<7) if ((!findPoss(i*8+j+1))&&(mass[i][j+1]=='0'))PossArr.add(new PossibleSt(i*8+j+1));
            if ((i<7)&&(j>0)) if ((!findPoss(i*8+j+7))&&(mass[i+1][j-1]=='0'))PossArr.add(new PossibleSt(i*8+j+7));
            if (i<7) if ((!findPoss(i*8+j+8))&&(mass[i+1][j]=='0'))PossArr.add(new PossibleSt(i*8+j+8));
            if ((i<7)&&(j<7)) if ((!findPoss(i*8+j+9))&&(mass[i+1][j+1]=='0'))PossArr.add(new PossibleSt(i*8+j+9));
        }
    }
    ...
    public int PointFour(int n, char[] mass1){
        ...
        for (int z =0; z<8;z++){
            if ((n>=z)&&(n-z<4)&&((z+3)<7)){
                if ((mass1[z]=='x')&&(mass1[z+1]=='x')&&(mass1[z+2]=='x')&&(mass1[z+3]=='x')) y=9999;
                else if ((mass1[z]=='0')&&(mass1[z+1]=='x')&&(mass1[z+2]=='x')&&(mass1[z+3]=='x')) y=400;
                else if ((mass1[z]=='x')&&(mass1[z+1]=='x')&&(mass1[z+2]=='x')&&(mass1[z+3]=='0')) y=400;
                else if ((mass1[z]=='x')&&(mass1[z+1]=='0')&&(mass1[z+2]=='x')&&(mass1[z+3]=='x')) y=250;
                else if ((mass1[z]=='x')&&(mass1[z+1]=='x')&&(mass1[z+2]=='0')&&(mass1[z+3]=='x')) y=250;
                else if ((mass1[z]=='x')&&(mass1[z+1]=='0')&&(mass1[z+2]=='0')&&(mass1[z+3]=='x')) y=60;
                else if ((mass1[z]=='0')&&(mass1[z+1]=='x')&&(mass1[z+2]=='x')&&(mass1[z+3]=='0')) y=85;
                else if ((mass1[z]=='x')&&(mass1[z+1]=='0')&&(mass1[z+2]=='x')&&(mass1[z+3]=='0')) y=75;
                else if ((mass1[z]=='0')&&(mass1[z+1]=='x')&&(mass1[z+2]=='0')&&(mass1[z+3]=='x')) y=75;
                k+=y;
                y=0;
            }
        }
    ...
    public int PointThree(int n, char[] mass1){
        ...
        for (int z=0;z<8;z++) {
            if ((n >= z) && (n -z<3) && (z +2 < 7)) {
                ...
                else if ((mass1[z] == '0') && (mass1[z + 1] == 'x') && (mass1[z + 2] == 'x')) y = 50;
                else if ((mass1[z] == 'x') && (mass1[z + 1] == 'x') && (mass1[z + 2] == '0')) y = 50;
                k += y;
                y = 0;
            }
        }
